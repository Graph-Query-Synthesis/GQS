...
public class KuzuGraphGraphGenerator {
    ...
    public KuzuGraphGraphGenerator(KuzuGraphGlobalState globalState){
        this.globalState = globalState;
    }

    public static List<CypherQueryAdapter> createGraph(KuzuGraphGlobalState globalState) throws Exception {
        return new KuzuGraphGraphGenerator(globalState).generateGraph(globalState.getSchema());
    }

    public List<CypherQueryAdapter> generateGraph(KuzuGraphSchema schema) throws Exception {
