package org.example.gqs.common.schema;
...
public abstract class AbstractTable<C extends AbstractTableColumn<?, ?>, I extends TableIndex, G extends GlobalState<?, ?, ?>>
    ...
    protected static final long NO_ROW_COUNT_AVAILABLE = -1;
    ...
    public List<C> getRandomNonEmptyColumnSubset(long size) {
    ...
    public String getFreeColumnName() {
        ...
        if (Randomly.getBooleanWithRatherLowProbability()) {
            i = (long) Randomly.getNotCachedInteger(0, 100);
        }
        do {
