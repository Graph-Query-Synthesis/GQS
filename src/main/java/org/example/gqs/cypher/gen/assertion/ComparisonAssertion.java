package org.example.gqs.cypher.gen.assertion;

import org.example.gqs.cypher.standard_ast.expr.BinaryComparisonExpression;
import org.example.gqs.cypher.standard_ast.expr.ExprVal;
...
public class ComparisonAssertion implements ExpressionAssertion {
    ...
    public boolean check(Object value) {
        ...
        if(value instanceof Number){
            long leftOp = ((Number)getLeftOp()).longValue();
            long rightOp = ((Number) value).longValue();
