...
public abstract class CypherSchema<G extends GlobalState<?,?,?>, A extends AbstractTable<?, ?, G>> extends AbstractSchema<G, A> implements ICypherSchema {
    ...
    protected List<CypherLabelInfo> labels;
    protected List<CypherRelationTypeInfo> relationTypes;
    protected List<CypherPatternInfo> patternInfos;
    ...
    public static class CypherRelationTypeInfo implements IRelationTypeInfo {
        ...
        public List<String> indexedProp = new ArrayList<>();
        public Label left, right;
        public Set<Pair<String, String>> fromto;

        public CypherRelationTypeInfo(String name, List<IPropertyInfo> properties) {
            this.name = name;
            this.properties = properties;
            this.fromto = new HashSet<>();
        }

        public CypherRelationTypeInfo(String name, List<IPropertyInfo> properties, Label left, Label right) {
            this.name = name;
            this.properties = properties;
            this.left = left;
            this.right = right;
