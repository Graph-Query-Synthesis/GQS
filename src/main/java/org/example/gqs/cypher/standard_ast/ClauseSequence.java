...
public class ClauseSequence implements IClauseSequence {
    ...
    public ClauseSequence(List<ICypherClause> clauseSequences){
        this.clauses = clauseSequences;
    }
    ...
    public void addClauseAt(ICypherClause clause, long index){
        if(index != 0 ) {
            clauses.get((int)index - 1).setNextClause(clause);
        }
        clauses.add((int)index, clause);
    }
    ...
    public static class ClauseSequenceBuilder implements IClauseSequenceBuilder, IClauseSequenceBuilder.IOngoingReturn,
        ...
        public static class IdentifierBuilder implements IIdentifierBuilder {
            public long nodeNum = 0, relationNum = 0, aliasNum = 0;
