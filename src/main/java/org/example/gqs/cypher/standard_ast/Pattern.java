...
public class Pattern implements IPattern {
    public List<IPatternElement> patternElements;
    ...
    public static class  PatternBuilder {
        ...
        public static class OngoingRelation {
            ...
            public OngoingRelation withOnlyLengthUpperBound(long lengthUpperBound){
                relationBuilder.withOnlyLengthUpperBound(lengthUpperBound);
                return this;
            }

            public OngoingRelation withOnlyLengthLowerBound(long lengthLowerBound){
                relationBuilder.withOnlyLengthLowerBound(lengthLowerBound);
                return this;
            }

            public OngoingRelation withLength(long length){
