...
public class Symtab implements ICypherSymtab {
    ...
    List<IAliasAnalyzer> localAliasDefs = null;
    List<INodeAnalyzer> availableNodePatterns = null;
    List<IRelationAnalyzer> availableRelationPatterns = null;
    ...
    public List<IAliasAnalyzer> getLocalAliasDefs() {
        if(localAliasDefs != null)
            return localAliasDefs;
    ...
    public List<INodeAnalyzer> getAvailableNodePatterns() {
        if(availableNodePatterns != null)
            return availableNodePatterns;
        if(!extendParent || parentClause.getPrevClause() == null){
        ...
        availableNodePatterns = nodes;
        return nodes;
    }

    @Override
    public List<IRelationAnalyzer> getAvailableRelationPatterns() {
        if(availableRelationPatterns!=null && availableRelationPatterns.size() > 0)
            return availableRelationPatterns;
        if(!extendParent || parentClause.getPrevClause() == null){
        ...
        availableRelationPatterns = relations;
        return relations;
    }
